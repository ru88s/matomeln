    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-sky max-w-none">
        <p className="text-gray-600 mb-6">
          シクマトの全ページ一覧です。お探しのページをクリックしてください。
        </p>

        <section className={`${componentStyles.card.base} mb-6`}>
          <h2 className="text-xl font-bold text-gray-900 mb-4">
            <svg className="w-5 h-5 inline-block mr-2 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <ul className="space-y-3">
            ...
            <li>
              <a href="/about" className="text-sky-600 hover:text-sky-700 font-medium">
                使い方
              </a>
              <span className="text-gray-500 text-sm ml-2">- シクマトの使用方法とFAQ</span>
            </li>
          </ul>
        </section>
        ...
        <section className={`${componentStyles.card.base} mb-6`}>
          ...
          <ul className="space-y-3">
            <li>
              <a href="https://shikutoku.me" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:text-sky-700 font-medium inline-flex items-center">
                Shikutoku（シクトク）
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
              </a>
              <span className="text-gray-500 text-sm ml-2">- コメント取得元のサービス</span>
            </li>
            <li>
              <a href="https://shikutoku.me/talks/6501" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:text-sky-700 font-medium inline-flex items-center">
                ご意見ご要望
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
            ...
            <li>
              <a href="https://shikutoku.me/contact" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:text-sky-700 font-medium inline-flex items-center">
                お問い合わせ
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
          ...
          <div className="bg-sky-50 p-4 rounded-xl">
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                ...
                <span>Shikutokuトークからコメントを取得（最大1000件）</span>
              </li>
              <li className="flex items-start">
                <span className="text-sky-500 mr-2">✓</span>
