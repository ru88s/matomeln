      ...
      <div className="prose prose-orange max-w-none">
        ...
        <section className={`${componentStyles.card.base} mb-6`}>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>5ch、2ch.sc、open2chのスレッドからコメントを取得する機能</li>
        ...
        <section className={`${componentStyles.card.base} mb-6`}>
          ...
          <div className="text-gray-700 space-y-3">
            <p>
              1. 当サービスで生成されるまとめ記事に含まれるコンテンツの著作権は、元の投稿者および各掲示板（5ch、2ch.sc、open2ch等）に帰属します。
            </p>
            <p>
        ...
        <section className={`${componentStyles.card.base} mb-6`}>
          ...
          <div className="text-gray-700 space-y-3">
            ...
            <p>
              4. 外部サービス（5ch、2ch.sc、open2ch、ライブドアブログ等）の障害、仕様変更等により
