...
- **色はカラーコードで指定してください（10色から選択）**：
  ...
  * "#000000" - 黒: 通常のレス、特に強調しないもの
  * null - 色なし（デフォルトの黒）

- **AIのセンスで自由に色を選んでください！**
  * 記事全体のバランスを考えて、様々な色を使ってカラフルにしてください
  * 感情や内容に合った色を直感的に選んでください
  * 連続して同じ色にならないよう、バリエーションを持たせてください
...
【色の使い方のコツ】
- まとめ記事が読みやすく、見栄えがするように色を使ってください
- 感情の起伏に合わせて色を変えると効果的です
- 全体の50-70%のレスに色を付けて、カラフルで楽しいまとめにしてください
- 連続して同じ色は避けてください（読みにくくなります）

【文字サイズルール - AIのセンスで自由に選択】
- **3種類のサイズから選べます**：
  * "large" - 大（22px）: 重要な発言、オチ、クライマックス、強調したい部分
  * null - 中（18px）: 通常のレス（デフォルト）
  * "small" - 小（14px）: 補足的な情報、脇役的なレス、淡々とした説明

- **AIのセンスで自由にサイズを使い分けてください！**
  * 重要なレスは大きく、補足的なレスは小さく
  * メリハリをつけて読みやすいまとめにしてください
  * 大: 10-20%、中: 60-70%、小: 10-20% くらいの配分が目安
  * 連続して同じサイズが続きすぎないようにしてください
