...
【文字サイズルール - 落ちや強調したいコメントは大に】
- **3種類のサイズから選べます**：
  * "large" - 大（22px）: **落ち、オチ、クライマックス、強調したい発言**
  * null - 中（18px）: 通常のレス（デフォルト）
  * "small" - 小（14px）: 補足的な情報、脇役的なレス

- **落ちコメント（スレの最後や面白いオチ）は必ず "large" にしてください**
- **重要なポイントや強調したい発言も "large" を使う**
- 大: 5-15%、中: 70-85%、小: 5-15% くらいの配分が目安
